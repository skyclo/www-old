...
export default function LinkCardThin({data}) {
    ...
    return (
        <a target="_blank" href={data.url} className="flex flex-row flex-grow px-8 py-8 w-full bg-light ring-1 ring-gray-500 ring-opacity-20 shadow-md hover:shadow-lg rounded-lg">
            <IconComponent
