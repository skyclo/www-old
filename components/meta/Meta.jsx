...
export default function HeadMetaTags ({pageTitle}) {
    ...
    return (
        <Head>
            ...
            <meta name="image" content="/images/og_thumbnail.png"/>
            ...
            <meta name="twitter:image" content="/images/og_thumbnail.png"/>
            ...
            <meta prefix="og: http://ogp.me/ns#" property="og:image" content="/images/og_thumbnail.png"/>
