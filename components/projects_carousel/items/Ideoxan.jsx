    ...
    return (
        <div className="flex flex-row w-full h-full px-4 md:px-6 lg:pl-12 lg:pr-0">
            <div className="flex flex-col flex-shrink my-auto mx-auto lg:mx-0">
                ...
                <p className="mt-2 mx-auto lg:mx-0 font-sans text-gray-200 font-medium text-normal text-center lg:text-left">Empowering the next generation of programmers, makers, and inventors.</p>
                <a href="https://ideoxan.com" className="mt-4 mx-auto lg:mx-0 px-8 py-3 bg-purple-600 w-max rounded-md text-sans text-purple-100 font-semibold text-sm shadow-sm">
                    Learn More
                </a>
            </div>
