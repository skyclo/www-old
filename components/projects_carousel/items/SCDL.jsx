    ...
    return (
        <div className="flex flex-row w-full h-full px-4 md:px-6 lg:px-12">
            <div className="flex flex-col flex-shrink my-auto mx-auto lg:mx-0">
                ...
                <a href="https://github.com/skyclo/node-scdl" className="mt-4 mx-auto lg:mx-0 px-8 py-3 bg-blue-500 w-max rounded-md text-sans text-blue-100 font-semibold text-sm shadow-sm">
