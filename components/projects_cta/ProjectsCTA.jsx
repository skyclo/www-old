...
export default function ProjectsCallToAction () {
    return (
        <div class="flex flex-col w-full py-16 bg-gray-950">
            ...
            <p className="mx-auto mt-2 font-sans font-medium text-center text-sm text-gray-200">Check out more of my projects and open source contributions on my GitHub profile.</p>
